...
FTE — эквивалент полной занятости: сколько человеко‑часов требуется для выполнения процессов.
• «Процессы» — горизонтальная диаграмма всех процессов с их FTE. Цвет = группа PCF.
• «Подразделения» — иерархия оргструктуры, FTE узла = прямой вклад + вклад дочерних.
              </div>
            </div>
